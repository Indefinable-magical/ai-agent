<template>
  <div class="home-container" :class="themeClass">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/stock-master')">
        <div class="card-glow"></div>
        <div class="app-icon stock-icon">📈</div>
        <div class="app-info">
          <div class="app-title">AI股票大师</div>
          <div class="app-desc">专业投研助手，帮你分析股票和风险</div>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI超级智能体应用平台提供AI股票大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI股票大师,AI助手,智能对话,股票分析,投研助手,首页'
    }
  ]
})
...
.stock-icon {
  ...
  box-shadow: 0 0 20px rgba(0, 200, 83, 0.45);
}
