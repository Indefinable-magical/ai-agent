...
/** 获取当前登录用户偏好 GET /user/preference */
export async function getUserPreference(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserPreferenceVO>("/user/preference", {
    method: "GET",
    ...(options || {}),
  });
}

/** 更新当前登录用户偏好 POST /user/preference/update */
export async function updateUserPreference(
  body: API.UserPreferenceUpdateRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseUserPreferenceVO>("/user/preference/update", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
/** 更新当前登录用户资料 POST /user/profile/update */
...
/** 上传当前登录用户头像 POST /user/avatar/upload */
